...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4, CH1, PB6,   TIM_USE_MC_SERVO | TIM_USE_FW_MOTOR, 0, 0),   // S5   UP1-5   D(1, 0, 2)
    DEF_TIM(TIM2, CH2, PB3,   TIM_USE_MC_SERVO | TIM_USE_FW_MOTOR, 0, 0),   // S6   UP1-6   D(1, 6, 3)
    //DEF_TIM(TIM2, CH1, PA15,  TIM_USE_MC_SERVO | TIM_USE_FW_MOTOR, 0, 0),   // S7   UP1-7   D(1, 5, 3)
    //DEF_TIM(TIM4, CH2, PB7,   TIM_USE_MC_SERVO | TIM_USE_FW_MOTOR, 0, 0),   // S8   UP1-8   D(1, 3, 2)
